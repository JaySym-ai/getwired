...
const mode = process.env.FAKE_CODEX_MODE ?? "default";

const stdoutEvents = [
  { type: "item.completed", item: { type: "agent_message", text: "Analyzing page structure at localhost:3000..." } },
  { type: "item.completed", item: { type: "agent_message", text: "Found 3 interactive elements." } },
  { type: "item.completed", item: { type: "agent_message", text: "Test plan: check form validation, nav links, footer." } },
];
