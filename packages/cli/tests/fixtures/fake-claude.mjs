...
const stdoutEvents = [
  { type: "assistant", message: { content: [{ type: "text", text: "Analyzing page structure at localhost:3000..." }] } },
  { type: "assistant", message: { content: [{ type: "text", text: "Found 3 interactive elements." }] } },
  { type: "assistant", message: { content: [{ type: "text", text: "Test plan: check form validation, nav links, footer." }] } },
];
